...
let activityIdList = [
    /*'e0c75515251f42469ef999fe6b199efc',
    ...
    'c2e032011e0a4411a12b013ca5b0d932',
    '6ba8abc444b14a5497978b750b8def00'*/
]
...
let activityIdList2 = [
    ...
    '6bebb8194c1545518cd57cedd3c87fef', 
    '065989322f6f47379483fa81656c8be2',
    "460146c7a49e4757ae13b213f4500a05"*/
]
// https://cjhy-isv.isvjcloud.com/sign/signActivity?activityId=
let activityIdList3 = [
    'c92c7564f4f44b918171fb531eefba3e',
    'e89fba7e4c9d426bb0b35e3b12d95422'
]
let lz_cookie = {}
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            for(let a in activityIdList3){
                $.activityUrl = `https://cjhy-isv.isvjcloud.com/sign/sevenDay/signActivity?activityId=${$.activityId}&venderId=${$.venderId}&adsource=&sid=&un_area=`
...
async function signActivity3() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            console.log(`签到 -> ${$.activityId}`)
            await task2('sign/sevenDay/wx/signUp',`actId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}`,1);
        } else {
            $.log("没有成功获取到用户信息")
        }
    } else {
